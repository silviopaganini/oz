...
(function() {
  var App, IFLLoader, IFLPhongFresnelShader,
  ...
  App = (function() {
    ...
    App.prototype.onTerrainLoaded = function(iflscene) {
      var descendant, descendants, fresnel, gui, _i, _len,
        _this = this;
      ...
      gui.add({
        value: 1
      }, 'value', 0, 20).name('Normal Scale').onChange(function(bindval) {
        return fresnel.uniforms['normalScale'].value = new THREE.Vector2(bindval, bindval);
      });
      $("#loading").remove();
